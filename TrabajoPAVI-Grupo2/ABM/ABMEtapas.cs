    ...
    public partial class formABMEtapa : Form
    {
        ...
        private void CargarGrilla()
        {
            ...
            try
            {
                ...
                string consulta = "SELECT * FROM Etapas ORDER BY id_etapa";
        ...
        private bool AgregarEtapaABD(Etapa etapa)
        {
            ...
            try
            {
                ...
                {
                    SqlCommand cmd = new SqlCommand();
                    string consulta = "INSERT INTO ETAPAS (id_etapa, descripcion) VALUES (@idEtapa, @Descripcion)";
                    cmd.Parameters.Clear();
