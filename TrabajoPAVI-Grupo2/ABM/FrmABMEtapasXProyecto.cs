    ...
    public partial class FrmABMEtapasXProyecto : Form
    {
        ...
        private void CargarComboEtapa()
        {
            ...
            try
            {
                ...
                string consulta = "SELECT id_etapa FROM ETAPAS ORDER BY id_etapa";
                cmd.Parameters.Clear();
        ...
        private bool AgregarEtapaXProyectoABD(EtapaXProyecto etapaXProyecto)
        {
            ...
            try
            {
                if (Existe(etapaXProyecto.CodProductoEtapaXProyecto, etapaXProyecto.IdEtapaXProyecto))
                {
                    MessageBox.Show("Esa etapa del proyecto ya existe");
                }
                else
                {
                    SqlCommand cmd = new SqlCommand();
        ...
        private static bool Existe(int cod_proyecto, string id_etapa)
        {
        ...
        private bool Eliminar(EtapaXProyecto etapaXProyecto)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    MessageBox.Show("La etapa que desea eliminar no existe");
